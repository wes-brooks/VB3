...
namespace VBTools
{
    ...
    public class ModelingInfo
    {
        ...
        private Globals.DependentVariableTransforms _depVarTransform;
        ...
        //Store the IronPython-based model state:
        private int _activeModelingTab;
        private IPyModelingControl.ProjectState _ipyPLSProject;
        ...
        public int ActiveModelingTab
        {
            set { this._activeModelingTab = value; }
            get { return this._activeModelingTab; }
        }

        public IPyModelingControl.ProjectState PlsProject
        {
            set { _ipyPLSProject = value; }
            get { return _ipyPLSProject; }
        }
    }
}
