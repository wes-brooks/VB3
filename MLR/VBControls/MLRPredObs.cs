...
namespace VBControls
{
    ...
    {
        //VBTools.VBProjectManager _projMgr = null;
        ...
        public Globals.DependendVariableTransforms Transform
        {
            set 
            {
                if (value == Globals.DependendVariableTransforms.none)
                {
                    rbValue.Checked = true;
                    _decisionThreshold = Convert.ToDouble(tbThresholdDec.Text);
                    _mandateThreshold = Convert.ToDouble(tbThresholdReg.Text);
                }
                else if (value == Globals.DependendVariableTransforms.Ln)
                {
                ...
                else if (value == Globals.DependendVariableTransforms.Log10)
                {
                ...
                else if (value == Globals.DependendVariableTransforms.Power)
                {
            ...
            {               
                if (rbLogeValue.Checked)
                    return Globals.DependendVariableTransforms.Ln;
                else if (rbLog10Value.Checked)
                    return Globals.DependendVariableTransforms.Log10;
                else if (rbPwrValue.Checked)
                    return Globals.DependendVariableTransforms.Power;
                else //(rbValue.Checked)
                    return Globals.DependendVariableTransforms.none;
            }                        
        }
        ...
        public void UpdateResults(List<double[]> data)
        {
            ...
            //    ppl.Add(pp);
            //}
            //zedGraphControl1.GraphPane.AddCurve("", ppl, Color.Green);
            //LineItem li = zedGraphControl1.GraphPane.CurveList[0] as LineItem;
