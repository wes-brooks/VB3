...
namespace Datasheet
{
    ...
    public partial class frmMissingValues : Form
    {
        ...
        private VBCommon.Metadata.dtColumnInformation _dtCI = null;
        private VBCommon.Metadata.dtRowInformation _dtRI = null;
        ...
        public frmMissingValues(DataGridView dgv, DataTable dt)
        {
            ...
            _dtRI = new VBCommon.Metadata.dtRowInformation(dt);
        ...
        {
            VBCommon.Controls.frmVariableSpecification frmCat = new VBCommon.Controls.frmVariableSpecification(_dt);
            frmCat.ShowDialog();
